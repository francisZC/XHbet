...
export default class EditableTable extends React.Component{
  ...
  render(){
    ...
    return(
      ...
      <div className="form-group" style={{position:"relative",background:"#FFFFFF",height:this.state.height,maxHeight:this.state.height,width:this.state.width,margin:this.state.margin,overflow:'scroll',overflowX:'hidden',overflowY:'hidden'}}>
        {tableList}   
      </div>
    )
  }
